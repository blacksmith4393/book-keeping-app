...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_home_home_component__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_login_login_component__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_navbar_navbar_component__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_profile_profile_component__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_register_register_component__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_search_search_component__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__app_config__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__guards_auth_guard__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_auth_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_books_service__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_user_service__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_validation_service__ = __webpack_require__(72);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["NgModule"])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_18__services_validation_service__["a" /* ValidationService */],
            __WEBPACK_IMPORTED_MODULE_14__guards_auth_guard__["a" /* AuthGuard */],
            __WEBPACK_IMPORTED_MODULE_13__app_config__["a" /* AppConfig */],
            __WEBPACK_IMPORTED_MODULE_16__services_books_service__["a" /* BooksService */]
        ],
...
var LoginComponent = (function () {
    function LoginComponent(auth, router, flashMessage) {
        this.auth = auth;
        this.router = router;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        var _this = this;
        this.auth.authenticateUser(this.user).subscribe(function (data) {
            if (data.success) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_validation_service__ = __webpack_require__(72);
...
var RegisterComponent = (function () {
    function RegisterComponent(router, auth, flashMessage, validationService) {
        this.router = router;
        this.auth = auth;
        this.flashMessage = flashMessage;
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        this.auth.registerUser(this.newUser).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('You are now registered and can log in', { cssClass: 'alert-success', timeout: 1500 });
                _this.router.navigate(['login']);
            }
            else {
    ...
    Object.defineProperty(RegisterComponent.prototype, "diagnostic", {
        // TODO: Remove this
        get: function () { return JSON.stringify(this.newUser); },
        enumerable: true,
        configurable: true
    });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_books_service__ = __webpack_require__(71);
...
var SearchComponent = (function () {
    function SearchComponent(booksService) {
    ...
    SearchComponent.prototype.onSearchSubmit = function (e) {
        ...
        this.booksService.searchBooks(this.book).subscribe(function (books) {
            _this.bookResults = books.items;
            console.log(_this.bookResults);
        }, function (err) {
            console.log(err);
            return false;
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_config__ = __webpack_require__(70);
...
var UserService = (function () {
    ...
    UserService.prototype.create = function (user) {
        return this.http.post(this.config.apiUrl + '/users/register', user, this.jwt()).map(function (res) { return res.json(); });
    };
    // update(user: User) {
...
module.exports = "<h2 class=\"page-header\">Login</h2>\n<form (submit)=\"onLoginSubmit()\" class=\"form-horizontal\">\n    <div class=\"form-group\">\n      <label for=\"inputUsername\" class=\"col-lg-2 control-label\">Username</label>\n      <div class=\"col-lg-10\">\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"user.username\" name=\"username\" id=\"inputUsername\" placeholder=\"Username\">\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"inputPassword\" class=\"col-lg-2 control-label\">Password</label>\n      <div class=\"col-lg-10\">\n        <input type=\"password\" class=\"form-control\" [(ngModel)]=\"user.password\" name=\"password\" id=\"inputPassword\" placeholder=\"Password\">\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <div class=\"col-lg-10 col-lg-offset-2\">\n        <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n      </div>\n    </div>\n</form>\n"
...
module.exports = "<nav class=\"navbar navbar-inverse navbar-static-top\">\n  <div class=\"container-fluid\">\n    <!-- Brand and toggle get grouped for better mobile display -->\n    <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" (click)=\"toggleState()\" data-toggle=\"collapse\" data-target=\"#bs-example-navbar-collapse-1\" aria-expanded=\"false\">\n        <span class=\"sr-only\">Toggle navigation</span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n      </button>\n      <a class=\"navbar-brand\" a routerLink=\"/home\"><span class=\"glyphicon glyphicon-book\" aria-hidden=\"true\"></span> MyBooks</a>\n    </div>\n\n    <!-- Collect the nav links, forms, and other content for toggling -->\n    <div class=\"collapse navbar-collapse\" [ngClass]=\"{ 'in': isIn }\" id=\"bs-example-navbar-collapse-1\">\n      <ul class=\"nav navbar-nav\">\n        <li routerLinkActive=\"active\"><a routerLink=\"/home\" (click)=\"toggleState()\">Home</a></li>\n      </ul>\n      <ul class=\"nav navbar-nav navbar-right\">\n        <li *ngIf=\"auth.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/search\" (click)=\"toggleState()\">Search</a></li>\n        <li *ngIf=\"auth.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/profile\" (click)=\"toggleState()\">Profile</a></li>\n        <li *ngIf=\"auth.loggedIn()\"><a href =\"#\" (click)=\"onLogoutClick()\">Logout</a></li>\n        <li *ngIf=\"!auth.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/login\" (click)=\"toggleState()\">Login</a></li>\n        <li *ngIf=\"!auth.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/register\" (click)=\"toggleState()\">Register</a></li>\n      </ul>\n    </div><!-- /.navbar-collapse -->\n  </div><!-- /.container-fluid -->\n</nav>"
...
module.exports = "\n<h2 class=\"page-header\">Register</h2>\n<form name=\"form\" #f=\"ngForm\" (ngSubmit)=\"onSubmit()\" class=\"form-horizontal\">\n    <div class=\"form-group\">\n      <label for=\"inputName\" class=\"col-lg-2 control-label\">Name</label>\n      <div class=\"col-lg-10\">\n        <input #test type=\"text\" [(ngModel)]=\"newUser.name\" name=\"name\" class=\"form-control\" id=\"inputName\" placeholder=\"Name\">\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"inputUsername\" class=\"col-lg-2 control-label\">Username</label>\n      <div class=\"col-lg-10\">\n        <input type=\"text\" [(ngModel)]=\"newUser.username\" name=\"username\" class=\"form-control\" id=\"inputUsername\" placeholder=\"Username\" required>\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"inputEmail\" class=\"col-lg-2 control-label\">Email</label>\n      <div class=\"col-lg-10\">\n        <input type=\"text\" [(ngModel)]=\"newUser.email\" name=\"email\" class=\"form-control\" id=\"inputEmail\" placeholder=\"Email\" required>\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"inputPassword\" class=\"col-lg-2 control-label\">Password</label>\n      <div class=\"col-lg-10\">\n        <input type=\"password\" [(ngModel)]=\"newUser.password\" name=\"password\" class=\"form-control\" id=\"inputPassword\" placeholder=\"Password\" required>\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <div class=\"col-lg-10 col-lg-offset-2\">\n        <button type=\"submit\" class=\"btn btn-primary\" [disabled]=\"!f.form.valid\">Submit</button>\n      </div>\n    </div>\n</form>"
...
module.exports = "<h2 class=\"page-header\">Search Books</h2>\n<form (submit)=\"onSearchSubmit($event)\" class=\"form-horizontal\">\n    <div class=\"form-group\">\n      <label for=\"title\" class=\"col-lg-2 control-label\">Title</label>\n      <div class=\"col-lg-10\">\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"book.title\" name=\"title\" id=\"title\" placeholder=\"Enter book title...\">\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"author\" class=\"col-lg-2 control-label\">Author</label>\n      <div class=\"col-lg-10\">\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"book.author\" name=\"author\" id=\"author\" placeholder=\"Enter book author...\">\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <div class=\"col-lg-10 col-lg-offset-2\">\n        <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n      </div>\n    </div>\n</form>\n<div *ngIf=\"bookResults\">\n  <h2 class=\"page-header\">Results</h2>\n  <div class=\"list-group\">\n    <a *ngFor=\"let book of bookResults\" href={{book.volumeInfo.canonicalVolumeLink}} class=\"list-group-item\"> \n      <h4 class=\"list-group-item-heading\">Title: {{book.volumeInfo.title}}</h4>\n      <p>Author: {{book.volumeInfo.authors[0]}}</p>\n      <p>Published: {{book.volumeInfo.publishedDate}}</p>\n    </a>\n  </div>\n</div>"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__auth_service__ = __webpack_require__(13);
...
var BooksService = (function () {
    ...
    BooksService.prototype.searchBooks = function (search) {
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["Headers"]();
        this.authToken = this.auth.getToken();
        headers.append('Authorization', this.authToken);
        headers.append('Content-Type', 'application/json');
        var query = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["URLSearchParams"]();
        ...
        var ep = this.auth.prepEndpoint('users/search');
        console.log(ep);
